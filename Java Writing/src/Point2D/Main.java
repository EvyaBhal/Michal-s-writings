...
public class Main
{
    ...
    public static void main( String[] args )
    {
        ...
        list[0].setX( 2 * list[0].getX() );
        list[1].setY( 2 * list[1].getY() );
        list[2].setX( 7 );
        list[2].setY( 1 );
        list[3].setPhi( 2 * list[3].getPhi() );
        list[4].setRho( 2 * list[4].getRho() );
        list[5].setX( 6.9 );
        list[5].setRho( 6.9 );
        list[6].setY( 1.2345 );
        list[7].setPhi( Math.PI / 3 );
        ...
        System.out.println( "setting p1.x to 6" );
        p1.setX( 6 );
        System.out.println( "p1 = " + toString( p1 ) );
        System.out.println( "setting p.y to 4" );
        p1.setY( 4 );
        System.out.println( "p1 = " + toString( p1 ) );

        System.out.println( "p2 = [Cratesian]: " + toString( p2 ) +
                "   [Polar]: (" + toString( p2.getRho(), len, frac ) + "," + toString( p2.getPhi(), len, frac ) + ")" );
        System.out.println( "setting p2.rho to 3" );
        p2.setRho( 3 );
        System.out.println( "p2 = [Cratesian]: " + toString( p2 ) +
                "   [Polar]: (" + toString( p2.getRho(), len, frac ) + "," + toString( p2.getPhi(), len, frac ) + ")" );
